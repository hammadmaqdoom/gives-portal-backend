  ...
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "class" ADD "is_public_for_sale" BOOLEAN NOT NULL DEFAULT false`,
    );
    await queryRunner.query(
      `ALTER TABLE "class" ADD "thumbnail_url" VARCHAR`,
    );
    await queryRunner.query(
      `ALTER TABLE "class" ADD "cover_image_url" VARCHAR`,
    );
    await queryRunner.query(
      `ALTER TABLE "class" ADD "features" JSONB`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "learning_module" ADD "is_previewable" BOOLEAN NOT NULL DEFAULT false`,
    );
