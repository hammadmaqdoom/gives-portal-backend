...
export class CreateUser1715028537217 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
      DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1 FROM pg_constraint WHERE conname = 'FK_75e2be4ce11d447ef43be0e374f'
        ) THEN
    ...
    await queryRunner.query(`
      DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1 FROM pg_constraint WHERE conname = 'FK_c28e52f758e7bbc53828db92194'
        ) THEN
    ...
    await queryRunner.query(`
      DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1 FROM pg_constraint WHERE conname = 'FK_dc18daa696860586ba4667a9d31'
        ) THEN
          ALTER TABLE "user" ADD CONSTRAINT "FK_dc18daa696860586ba4667a9d31" 
    ...
    await queryRunner.query(`
      DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1 FROM pg_constraint WHERE conname = 'FK_3d2f174ef04fb312fdebd0ddc53'
        ) THEN
          ALTER TABLE "session" ADD CONSTRAINT "FK_3d2f174ef04fb312fdebd0ddc53" 
