...
import { LearningModulesController, LearningModuleSectionsController } from './learning-modules.controller';
...
@Module({
  imports: [
    TypeOrmModule.forFeature([LearningModuleEntity, LearningModuleSectionEntity, ModuleCompletionEntity]),
  ],
  controllers: [LearningModulesController, LearningModuleSectionsController, ModuleCompletionController],
  providers: [
